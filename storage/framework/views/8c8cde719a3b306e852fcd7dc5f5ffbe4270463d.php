		...
		<div class="panel panel-default">
		    ...
		    <form method="post" role="form" action="/cadastro/propriedade">
		    	<div class="form-group">
		    		...
		    		<input type="text" name="denominacao" id="denominacao" class="form-control" placeholder="Ex.: Fazenda Paineiras" value="<?php echo e(old('denominacao')); ?>">
		    	...
		    	<div class="row">
			    	<div class="form-group col-xs-8">
			    		...
			    		<input type="text" name="proprietario" id="proprietario" class="form-control" value="<?php echo e(old('proprietario')); ?>">
			    	</div>
			    	<div class="col-xs-4">
			    		<label for="area">Área (ha)</label>
			    		<input type="text" name="area" id="area" class="form-control" value="<?php echo e(old('area')); ?>">
			    	</div>
		    	</div>
		    	<div class="row">
		    		<div class="form-group col-xs-4">
			    		<label for="itr">Número do ITR (NIRF)</label>
			    		<input type="text" name="itr" id="itr" class="form-control" value="<?php echo e(old('itr')); ?>">
			    	</div>
			    	<div class="form-group col-xs-4">
			    	...
			    	<div class="form-group col-xs-4">
			    		...
			    		<input type="date" name="dt_geracao" id="dt_geracao" class="form-control" value="<?php echo e(old('dt_geracao')); ?>">
			    	</div>
		    	</div>
		    	<div class="row">
		    		<div class="form-group col-xs-4">
			    		<label for="cod_imovel">Código do imóvel rural (CCIR)</label>
			    		<input type="text" name="cod_imovel" id="cod_imovel" class="form-control" value="<?php echo e(old('cod_imovel')); ?>">
			    	</div>
			    	<div class="form-group col-xs-4">
			    		<label for="modulos_fiscais">Número de Módulos Rurais (CCIR)</label>
			    		<input type="text" name="modulos_fiscais" id="modulos_fiscais" class="form-control" value="<?php echo e(old('modulos_fiscais')); ?>">
			    	</div>
			    	<div class="form-group col-xs-4">
			    		<label for="num_autencidade">Número de Autenticidade (CCIR)</label>
			    		<input type="text" name="num_autencidade" id="num_autencidade" class="form-control" value="<?php echo e(old('num_autencidade')); ?>">
			    	</div>
		    	</div>
		    	<div class="row">
		    		<div class="form-group col-xs-6">
			    		<label for="registro_car">Registro do CAR</label>
			    		<input type="text" name="registro_car" id="registro_car" class="form-control" value="<?php echo e(old('registro_car')); ?>">
			    	</div>
			    	<div class="form-group col-xs-6">
			    		<label for="dt_cadastro">Data de cadastro (CAR) </label>
			    		<input type="date" name="dt_cadastro" id="dt_cadastro" class="form-control" value="<?php echo e(old('dt_cadastro')); ?>">
			    	</div>			    	
		    	</div>
		    	<div class="row">
		    		<div class="form-group col-xs-6">
			    		<label for="area_rl">Área de Reserva Legal</label>
			    		<input type="text" name="area_rl" id="area_rl" class="form-control" value="<?php echo e(old('area_rl')); ?>">		    			
		    		</div>
		    		<div class="form-group col-xs-6">
			    		<label for="averbacao">Número da averbação da Reserva Legal</label>
			    		<input type="text" name="averbacao" id="averbacao" class="form-control" value="<?php echo e(old('averbacao')); ?>">		    			
		    		</div>
		    	</div>
		    	<div class="row">
		    		<div class="form-group col-xs-4">
			    		<label for="cod_cartorio">Cartório</label>
			    		<select type="text" name="cod_cartorio" id="cod_cartorio" class="form-control" value="<?php echo e(old('cod_cartorio')); ?>">	
			    			<option></option>
		    		...
		    		<div class="form-group col-xs-4">
			    		...
			    		<input type="text" name="matricula" id="matricula" class="form-control" value="<?php echo e(old('matricula')); ?>">		    			
		    		</div>
		    		<div class="form-group col-xs-2">
			    		<label for="livro">Livro</label>
			    		<input type="text" name="livro" id="livro" class="form-control" value="<?php echo e(old('livro')); ?>">		    			
		    		</div>
		    		<div class="form-group col-xs-2">
			    		<label for="folha">Folha</label>
			    		<input type="text" name="folha" id="folha" class="form-control" value="<?php echo e(old('folha')); ?>">		    			
		    		</div>
		    	</div>
		    	<br>
