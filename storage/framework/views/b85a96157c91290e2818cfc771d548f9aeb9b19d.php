					      ...
					      <label for="tipo_contato">Tipo de contato</label>
					      	<div class="row">
						    	<div class="form-group col-xs-6">
						    		...
						    		<select type="text" name="tipo_contato" id="tipo_contato" class="form-control" onchange="" maxlength="10" placeholder="Ex.: 00000-000" value="<?php echo e(old('cep')); ?>">
