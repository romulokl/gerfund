...
class ConsultaController extends Controller
{
			...
			if($resultados){
				foreach ($resultados as $key => $resultado) {
					$output.='<tr>'.
								...
								'<td><a href="{{action('FundiarioController@detalhes', $resultado->cod_propriedade)}}"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#detalhes" id="detalhes">Detalhes</button></a></td>'.
							'</tr>';
				}
	...
	public function detalhes($cod_propriedade){

		$item = Propriedade::find($cod_propriedade);
		return view('consulta.detalhes')->with('item', $item);
	}
